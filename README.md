...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/amp-atomistics-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/amp-atomistics-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add amp-atomistics
# for installing globally
pixi global install amp-atomistics
```
...
It is possible to list all of the versions of `amp-atomistics` available on your platform:
...
```
pixi search amp-atomistics --channel conda-forge
```
